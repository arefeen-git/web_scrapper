...
class HomeController extends AbstractController {
    ...
    public function index(): Response {
        ...
        $cookie_consent = 
                <<<EOT
                    curl 'https://rekvizitai.vz.lt/en/company-search/1/' --compressed -X POST -H 'User-Agent: Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:109.0) Gecko/20100101 Firefox/116.0' -H 'Accept: text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,*/*;q=0.8' -H 'Accept-Language: en-US,en;q=0.5' -H 'Accept-Encoding: gzip, deflate, br' -H 'Referer: https://rekvizitai.vz.lt/en/company-search/' -H 'Content-Type: multipart/form-data; boundary=---------------------------375544251624973015593184047228' -H 'Origin: https://rekvizitai.vz.lt' -H 'Connection: keep-alive' -H 'Cookie: cf_clearance=qQeQT3IVRX9q3lpGRFYqVCUlC20lP1sVH8QcnE02USI-1691707988-0-1-afbe41c0.37dbf413.f8bf1e20-250.2.1691707988; CookieScriptConsent=%7B%22googleconsentmap%22%3A%7B%22ad_storage%22%3A%22targeting%22%2C%22analytics_storage%22%3A%22performance%22%2C%22functionality_storage%22%3A%22functionality%22%2C%22personalization_storage%22%3A%22functionality%22%2C%22security_storage%22%3A%22functionality%22%7D%2C%22action%22%3A%22accept%22%2C%22categories%22%3A%22%5B%5C%22unclassified%5C%22%2C%5C%22targeting%5C%22%5D%22%2C%22key%22%3A%22369b58f2-acac-4d82-b25d-1bc1341aee25%22%7D; _ga_D931ERQW91=GS1.1.1691707984.12.1.1691708757.0.0.0; _ga=GA1.2.18986035.1689089881; visid_incap_1823587=f462hnsfRH6Ee+vE/NX551t3rWQAAAAAQUIPAAAAAACR+VXbsRUl3RV3HhyXFpw0; VzLtLoginHash=0GIy66Wp3ggVkeN0IC; _gid=GA1.2.821224099.1691419940; PHPSESSID=ds8ap3gh0q05cdeudkl7dmukp4; nlbi_1823587=XRM1Fxbw7zA94pEQq9G9pQAAAAB+F7z+BLUWp/ttQEM5l04+; _gat_UA-724652-3=1; incap_ses_219_1823587=4rj+EF3shmu39FG04gsKA1dt1WQAAAAA28W7Fkz8IVNDmrqhIpkc0Q==' -H 'Upgrade-Insecure-Requests: 1' -H 'Sec-Fetch-Dest: document' -H 'Sec-Fetch-Mode: navigate' -H 'Sec-Fetch-Site: same-origin' -H 'Sec-Fetch-User: ?1' -H 'TE: trailers' --data-binary $'-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="name"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="word"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="code"\r\n\r\n304422799\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="codepvm"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="city"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="search_terms"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="street"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="employeesMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="employeesMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="salaryMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="salaryMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="debtMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="debtMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="transportMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="transportMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="salesRevenueMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="salesRevenueMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="netProfitMin"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="netProfitMax"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="registeredFrom"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="registeredTo"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="search_terms"\r\n\r\n\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="order"\r\n\r\n1\r\n-----------------------------375544251624973015593184047228\r\nContent-Disposition: form-data; name="resetFilter"\r\n\r\n0\r\n-----------------------------375544251624973015593184047228--\r\n'
                EOT;
...
//        $registration_code = 301150098, 300150177, 304557850, 126060443;
        $registration_code = 126060443;
...
//        $browser_elemnts = $this->scraperUtility->processCurl($cookie_consent, $registration_code);
        ...
        $cookie         = $browser_elemnts['cookie'];
        $content_type   = $browser_elemnts['content-type'];
